<template>
	<div>
		<div class="register_main">
			...
			<div><el-button type="success" class="login_btn register_btn" @click="register()">确认</el-button></div>	
			</div>
		</div>
		<!-- 注册成功弹框 -->
		<transition name="el-fade-in">
			<div class="mask register_mask" v-show="show">
				...
				<div>
					<p class="tc f20 register_text">恭喜修改成功！</p>
