			...
			<div class="payment_list bg_white c666 flex f14 tl line1 mt20" v-for="(item,index) in list">
				<div class="payment_list_one">
					...
					<div class="payment_list_two_lab">
						...
						<ul>
							<li>货物到达实际重量</li>
							<li style="padding-left: 13px;">毛重{{item.arriveRough}}t 皮重{{item.arriveTare}}t 净重{{item.arriveSuttle}}t 扣水{{info.deductWater}}t 扣杂{{info.deductMix}}t 扣重{{item.deductTon}}t</li>
						</ul>
					</div>
					<div class="payment_list_two_lab">
						<span></span>
